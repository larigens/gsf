                ...
                <Row className="d-flex justify-content-center">
                    ...
                    <Col md={8} className={classNames(theme === 'Light Mode' ? 'secondary-bg' : 'bg-dark-accent', 'me-auto p-5 radius-20')}>
                        ...
                        <p className="fs-18 text-justify my-4">
                            ...
                            Make sure to check the credit and payment history on your customers prior to hauling a load. Don't haul for someone that does not pay!
                        </p>
                        ...
                        <Row className="mx-1 mt-4">
                            <Button className="my-2 contact-btn px-2 py-1 radius-20 border-none" role="button" href="https://www.factorsnetwork.com/login">
                                <span className="contact-btn-span px-3 fs-22">Check Credit
                                    <Image className="img-fluid ms-2 mb-1 arrow-icon icon-color btn-icon" src={creditScore} alt="credit-score icon" width="30" loading="lazy" />
                                </span>
                            </Button>
                        </Row>
