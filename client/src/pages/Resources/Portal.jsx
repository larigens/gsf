...
export const Portal = () => {
    ...
    return (
        <>
            <HelmetCP pageTitle={'Client Portal'}
                ...
                <Row className="d-flex justify-content-center">
                    ...
                    <Col md={6} className={classNames(theme === 'Light Mode' ? 'secondary-bg' : 'bg-dark-accent', 'me-auto p-5 radius-20')}>
                        ...
                        <p className="fs-18 text-justify my-4">
                            You can easily submit your paperwork to your Client Relations Manager by logging into your account. You can also review any outstanding invoices and view funding reports, just click below!</p>
                        <Row className="mx-1 mt-4">
                            ...
                            <p>Don't have access?  <Link class="link-color hover-link-color fs-18" to="mailto:dramirez@gsquaredfunding.com?subject=Login%20Request%20for%20WinFactor%20Client%20Portal"> Request a Login </Link></p>
                        </Row>
                    </Col>
                </Row>
            </Container>
