...
export const WorkingGSF = () => {
                    ...
                    <Row className="text-center fs-19">
                        ...
                        <Container fluid className='letter my-3 w-40 radius-10'>
                            <Row fluid className='text-start'>
                                ...
                                <Col md={4} className='d-flex align-items-center text-end mb-2'>
    ...
    // Add info for fuel card application.

    return (
        <>
            <HelmetCP pageTitle={'Working with GSF | Simple Freight Factoring'}
