...
export const Referral = () => {
    ...
    // Create an ObjectId instance from the string id
    const getId = new ObjectId(id);

    // Pass getId directly to GetReferral
    const referral = GetReferral(getId);
    ...
    return (
        <>
            <HelmetCP pageTitle={`Factoring Services | ${referral.company}`}
            ...
            <Container fluid className="mb-4 p-4">
                <Row className="d-flex align-items-center">
                    <Col md={6}>
                        ...
                        <p className="text-justify my-3 tracking-in-expand fst-italic fs-26">Referred by <span className='secondary-color'>{referral.company}</span></p>
                    </Col>
                ...
                <p className="text-justify mt-3 mb-2 fs-24 pe-4">You can
                    ...
                    if you have any inquiries regarding factoring or need assistance with the signup process. Please kindly mention that you were referred to us by our esteemed partner, {referral.company}!</p>
                ...
                <Row>
                    <Col md={4} className="mb-2 me-3">
                        {/* Need to create a form specific for each id */}
                        <FormCP />
                    </Col>
                    <Col md={7}>
                        <div className="ml-3 pl-4">
                            ...
                            <Link to={pdf} download='gsf_application.pdf' className="d-flex align-items-center mt-3 link-color hover-link-color">
