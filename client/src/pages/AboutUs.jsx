            ...
            <Row className="mt-5 text-justify">
                <Container fluid
                    ...
                    <Container fluid className="d-flex align-items-center mb-2">
                        ...
                        <p className="font-weight-bold mb-0 fs-22">Industry Leadership</p>
                    </Container>
                    ...
                    <Container fluid className="d-flex align-items-center mb-2">
                        <Image className="me-2 icon-20" src={line} alt="trucks" loading="lazy" />
                        <p className="font-weight-bold mb-0 fs-22">Immediate Solutions</p>
                    </Container>
                    ...
                    <Container fluid className="d-flex align-items-center mb-2">
                        <Image className="me-2 icon-20" src={line} alt="trucks" loading="lazy" />
                        <p className="font-weight-bold mb-0 fs-22">Exceptional Customer Service</p>
                    </Container>
                    ...
                    <Container fluid className="d-flex align-items-center mb-2">
                        <Image className="me-2 icon-20" src={line} alt="trucks" loading="lazy" />
                        <p className="font-weight-bold mb-0 fs-22">Simplified Factoring</p>
                    </Container>
